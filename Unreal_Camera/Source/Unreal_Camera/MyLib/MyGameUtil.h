...
struct MyGameUtil {
	...
	static void GetAllActorsWithTag(TArray<AActor*>& OutActors, const FName& InTag);
	static void GetAllActorsOfClass(TArray<AActor*>& OutActors, const TSubclassOf<AActor>& InActorClass);
};
