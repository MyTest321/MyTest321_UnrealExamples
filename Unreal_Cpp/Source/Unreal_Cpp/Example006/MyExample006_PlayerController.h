...
#include "MyExample006_PlayerController.generated.h"

class AMyExample006_Character;
class APawn;

UCLASS()
class UNREAL_CPP_API AMyExample006_PlayerController : public APlayerController {
	GENERATED_BODY()
public:
	...
	AMyExample006_PlayerController();
